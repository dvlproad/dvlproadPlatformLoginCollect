...
- (void)viewDidLoad {
    ...
    self.title = NSLocalizedString(@"测试Flutter Login", nil);
    ...
    [cjTestButton setTitle:@"测试Flutter Login Demo" forState:UIControlStateNormal];
    ...
    [cjTestButton addTarget:self action:@selector(showFlutterLoginViewController) forControlEvents:UIControlEventTouchUpInside];
...
- (void)showFlutterLoginViewController {
